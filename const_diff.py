...
for x in range(inputimage.width):
    for y in range(inputimage.height):
        if (x%2==1)&(y%2==0):
            ...
            if (y-1 > 0)&(x-1 > 0):
                bcount += 1
                btot += pixelsin[x-1,y-1][2] - pixelsin[x-1,y-1][1]
            ...
            if (y+1 < inputimage.height)&(x-1 > 0):
                bcount += 1
                btot += pixelsin[x-1,y+1][2] - pixelsin[x-1,y+1][1]
            pixelsout[x,y] = (pixelsin[x,y][0],pixelsin[x,y][1],int(pixelsin[x,y][1]+(btot/bcount)))
        elif (x%2==0)&(y%2==1):
            ...
            if (y-1 > 0)&(x-1 > 0):
                rcount += 1
                rtot += pixelsin[x-1,y-1][0] - pixelsin[x-1,y-1][1]
            if (y-1 > 0)&(x+1 < inputimage.width):
                rcount += 1
                rtot += pixelsin[x+1,y-1][0] - pixelsin[x+1,y-1][1]
            if (y+1 < inputimage.height)&(x+1 < inputimage.width):
            ...
            if (y+1 < inputimage.height)&(x-1 > 0):
                rcount += 1
                rtot += pixelsin[x-1,y+1][0] - pixelsin[x-1,y+1][1]
            pixelsout[x,y] = (int(pixelsin[x,y][1]+(rtot/rcount)),pixelsin[x,y][1],pixelsin[x,y][2])
        elif (x%2==0)&(y%2==0):
            ...
            if (y-1 > 0):
                bcount += 1
                btot += pixelsin[x,y-1][2] - pixelsin[x,y-1][1]
            if (y+1 < inputimage.height):
                bcount += 1
                btot += pixelsin[x,y+1][2] - pixelsin[x,y+1][1]
            rtot=0
            ...
            if (x-1 > 0):
                rcount += 1
                rtot += pixelsin[x-1,y][0] - pixelsin[x-1,y][1]
            if (x+1 < inputimage.width):
                rcount += 1
                rtot += pixelsin[x+1,y][0] - pixelsin[x+1,y][1]
            pixelsout[x,y] = (int(pixelsin[x,y][1]+(rtot/rcount)),pixelsin[x,y][1],int(pixelsin[x,y][1]+(btot/bcount)))
        else:
            ...
            if (y-1 > 0):
                rcount += 1
                rtot += pixelsin[x,y-1][0] - pixelsin[x,y-1][1]
            if (y+1 < inputimage.height):
                rcount += 1
                rtot += pixelsin[x,y+1][0] - pixelsin[x,y+1][1]
            btot=0
            ...
            if (x-1 > 0):
                bcount += 1
                btot += pixelsin[x-1,y][2] - pixelsin[x-1,y][1]
            if (x+1 < inputimage.width):
                bcount += 1
                btot += pixelsin[x+1,y][2] - pixelsin[x+1,y][1]
            pixelsout[x,y] = (int(pixelsin[x,y][1]+(rtot/rcount)),pixelsin[x,y][1],int(pixelsin[x,y][1]+(btot/bcount)))
